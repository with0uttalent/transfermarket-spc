...
// Overridable so containerised deployments can keep the DB on a mounted
// volume (e.g. DB_PATH=/data/transfermarket.db).
const DB_PATH = process.env.DB_PATH || path.join(__dirname, 'transfermarket.db');
